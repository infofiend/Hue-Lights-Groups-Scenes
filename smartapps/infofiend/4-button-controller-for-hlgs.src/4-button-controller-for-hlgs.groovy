 ...
 *
 *	4 Button Controller for HLGS
 *
 *	Author: Anthony Pastor (based closely on SmartThings's original Button Controller App)
 *	Date: 2016-5-4
 */
definition(
    name: "4 Button Controller for HLGS",
    namespace: "infofiend",
    author: "Anthony Pastor",
    description: "Control devices (including HLGS Scenes) with 4 buttons like the Aeon Labs Minimote",
